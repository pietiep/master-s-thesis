...
\backmatter % ab hier keine Nummerierung mehr
   ...
   \bibliographystyle{apsrev} % oder anderen Stil
    \bibliography{./bibtex/eigen,./bibtex/MCTDH,./bibtex/SPP96,./bibtex/python,./bibtex/PyQt,./bibtex/sonstig} % bibtex-file
\end{document}
