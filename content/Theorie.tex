...
%\section{MCTDH}
 ...
 Die Effizienz des MCTDH-Verfahrens resultiert aus der Doppellayerstruktur der verwendeten Wellenfunktion. In anderen Wellenpaktdynamikverfahren, 
...
Anstelle die Wellenfunktion in einer zeitunabh"angigen Basis zu entwickeln,
...
Die Anzahl der Konfigurationen, die in der MCTDH-Wellenfunktion enthalten ist, betr"agt bei $ f $ kor\-relierten Koordinaten $ 2^f $ Konfigurationen.
...
und System-Bad-Mo\-del\-le \cite{W, WTM, NM2} durch das Modenkombinationsverfahren behandelt werden.
...
Zun"achst  werden die Wellenfunktionen der Standardmethode, des Zweilagen-MCTDHs und des moden\-kombi\-nierten MCTDH betrachtet,
