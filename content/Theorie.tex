...
Die Konfigurationen des l-ten Layers $ \Phi^{\kappa_1,\kappa_2,...,\kappa_{l-1}}_j $ werden durch das Produkt der SPFs definiert:
 ...
 gekennzeichnet.
  \\Bevor die Bewegungsgleichungen f"ur die MCTDH-Methode hergeleited werden, wird die Standardmethode der Propagation der Wellenfunktion betrachtet.
